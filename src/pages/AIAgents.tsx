            ...
            <div className="grid grid-cols-2 gap-4">
              {agents.map((agent) => (
                <div
                  ...
                  className={`cursor-pointer rounded-xl border bg-card p-5 shadow-card transition-all hover:shadow-elevated ${selectedAgent?.id === agent.id ? "border-primary ring-1 ring-primary/20" : "border-border"}`}
                >
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex items-center gap-3">
                      <div className="flex h-11 w-11 items-center justify-center rounded-xl" style={{ background: typeColors[agent.type] }}>
              ...
              <div className="space-y-3 mb-6">
                <div className="flex items-center justify-between rounded-lg bg-muted/50 p-3">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs text-foreground">Personalidade</span>
                  </div>
                ...
                <div className="flex items-center justify-between rounded-lg bg-muted/50 p-3">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs text-foreground">Modelo IA</span>
                  </div>
                ...
                <div className="flex items-center justify-between rounded-lg bg-muted/50 p-3">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs text-foreground">Escalação humana</span>
                  </div>
