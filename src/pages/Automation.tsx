...
import { Zap, Play, Pause, Plus, MoreHorizontal, MessageSquare, Clock, Users, Filter, GitBranch, Mail, Bot, ChevronRight, ToggleLeft, ToggleRight } from "lucide-react";
              ...
              {flows.map((flow) => {
                ...
                return (
                  <div
                    ...
                    className={`group cursor-pointer rounded-xl border bg-card p-4 shadow-card transition-all hover:shadow-elevated ${selectedFlow?.id === flow.id ? "border-primary ring-1 ring-primary/20" : "border-border"}`}
                  >
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-3 mt-2">
                            ...
                            <span className="text-[10px] text-muted-foreground">·</span>
                            <span className="text-[10px] text-muted-foreground">{flow.steps} etapas</span>
                          </div>
                        </div>
                      </div>
                      <div className="flex items-center gap-2">
