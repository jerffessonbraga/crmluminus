        ...
        <div className="flex-1 overflow-y-auto p-6">
          {view === "list" ? (
            <div className="space-y-3">
              {mockPosts.map((post) => (
                <div key={post.id} className="rounded-xl border border-border bg-card p-4 shadow-card hover:shadow-elevated transition-all cursor-pointer">
            ...
            <div className="rounded-xl border border-border bg-card shadow-card overflow-hidden">
              ...
              <div className="grid grid-cols-7">
                ...
                {calendarDays.map((day) => {
                  ...
                  const isToday = day === 7;
                  return (
                    <div key={day} className={`min-h-[80px] border-b border-r border-border p-1.5 ${isToday ? "bg-primary/5" : ""}`}>
